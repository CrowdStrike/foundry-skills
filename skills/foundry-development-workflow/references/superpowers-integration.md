...
When the [superpowers](https://github.com/obra/superpowers) plugin is installed, **the foundry-development-workflow skill still owns the Foundry development flow**. Superpowers skills supplement but do not replace this workflow:
...
```bash
# Delegate ALL OpenAPI spec work to the foundry-api-integrations sub-skill.
...
- **OpenAPI spec content** — delegate to foundry-api-integrations sub-skill
