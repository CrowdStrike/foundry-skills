...
> Parent skill: [foundry-security-patterns](../SKILL.md)
...
- **foundry-ui-development:** XSS and CSP enforcement
- **foundry-functions-development:** Secure coding patterns
- **foundry-collections-development:** Access controls and validation
- **foundry-workflows-development:** Secure automation patterns
