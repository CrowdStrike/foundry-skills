...
- **foundry-collections-development:** UI consumes generated TypeScript types from schemas
- **foundry-functions-development:** UI calls function endpoints via Foundry SDK
- **foundry-security-patterns:** Apply XSS prevention and CSP patterns (see that skill)
- **foundry-debugging-workflows:** Use for `foundry ui run` startup issues
